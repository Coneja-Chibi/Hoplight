...
- Stage that character for the Press and its linked lorebooks ride along as a troupe, even books you never staged, and a book already riding a troupe is never printed twice.
...
✍️ You open her on the Workbench with the lens set to "RisuAI":
 ...
 ↓
🖨️ You stage her for the Press, and her linked book rides along automatically as her troupe
 ↓
...
| 🎭 **Characters** | Travel with their linked lorebooks; troupes are first-class |
...
<details>
<summary><i>Staging, troupes, readiness, filenames and flavor, the run</i></summary>
...
### 🎁 **Troupes** *(a character travels with its luggage)*

**A staged character isn't just a character. It's a troupe.** Every lorebook linked to him climbs into the trunk automatically, even books you never staged yourself.

| Troupe behavior | What happens |
|---|---|
...
| 🚫 **No doubling** | A staged book already riding a troupe isn't printed twice |
...
press/        : batch export - the staged queue, troupes (character + linked books),
