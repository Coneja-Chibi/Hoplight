...
var BACKDROP_CSS_CAP = 1e5;
var CLOSE_STYLE = /<\s*\/\s*style\b[^>]*>?/gi;
...
var BACKDROP_HTML_CAP = 200000;
var FORBID_TAGS = [...SEALED_FORBID_TAGS];
var SEALED_PREVIEW_CSP = "default-src 'none'; img-src data: blob:; media-src data: blob:; " + "style-src 'unsafe-inline'; script-src 'none'; font-src 'none'; connect-src 'none'; " + "frame-src 'none'; object-src 'none'; base-uri 'none'; form-action 'none'";
var purifier = null;
var boundTo = null;
function sanitizer() {
...
function SealedHtmlPreview({
  ...
  const srcDoc = useMemo(() => buildBackdropSrcDoc(html2, css), [html2, css]);
  const frameRef = useRef(null);
  useFocusStaysOutside(frameRef);
  return /* @__PURE__ */ jsxDEV("iframe", {
    ref: frameRef,
    tabIndex: -1,
...
function takeHandedHtml() {
  ...
  try {
    ...
    if (parsed.at === "inline" && typeof parsed.html === "string")
      return parsed;
    if (parsed.at === "piece" && typeof parsed.id === "string")
      return parsed;
    return null;
  } catch {
    return null;
...
var styles_module_default2 = {
  room: "room_wReSrQ",
  head: "head_wReSrQ",
  eyebrow: "eyebrow_wReSrQ",
  title: "title_wReSrQ",
  lede: "lede_wReSrQ",
  quiet: "quiet_wReSrQ",
  frame: "frame_wReSrQ",
  big: "big_wReSrQ",
  expand: "expand_wReSrQ"
};

// src/ui/apps/html-view/index.tsx
import { jsxDEV as jsxDEV2 } from "react/jsx-dev-runtime";
var MARK_SVG = '<svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.2">' + '<rect x="3.5" y="4.5" width="17" height="15"/><path d="M3.5 9h17"/><path d="M7 6.6h.01"/></svg>';
var ACCENT = "#c2683f";
function HtmlView({ ctx }) {
  const [drawing, setDrawing] = useState(null);
  const [problem, setProblem] = useState(null);
  const frameRef = useRef2(null);
  const [big, setBig] = useState(false);
  const goBig = useCallback(async () => {
    setBig(true);
  ...
  useEffect2(() => onHtmlHandoff(() => setHandoff(takeHandedHtml())), []);
  useEffect2(() => {
    let cancelled = false;
    if (!handoff) {
      setDrawing(null);
    ...
    if (handoff.at === "inline") {
      setDrawing({ html: handoff.html });
      setProblem(null);
      return;
    }
    setProblem(null);
  ...
  const html2 = drawing?.html ?? null;
  useEffect2(() => {
    ctx.setStatus(drawing ? `html view · ${drawing.name ?? "from a reply"} · ${drawing.html.length} characters` : "html view · nothing to draw");
  }, [ctx, drawing]);
      ...
      /* @__PURE__ */ jsxDEV2("header", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxDEV2("h1", {
            ...
            children: drawing?.name ?? (html2 ? "What the agent drew" : "Nothing to draw yet")
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsxDEV2("p", {
            className: styles_module_default2.lede,
            children: html2 ? "Rendered with scripts and network access off, so this is layout and styling only - " + "what a browser would paint, minus anything that would run or phone out." : "Ask the agent for a wireframe or a mockup, then open it from the reply. This tab draws " + "whatever it hands over."
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this),
      html2 ? /* @__PURE__ */ jsxDEV2("div", {
        className: big ? `${styles_module_default2.frame} ${styles_module_default2.big}` : styles_module_default2.frame,
        ref: frameRef,
        children: [
          /* @__PURE__ */ jsxDEV2("button", {
            type: "button",
            className: styles_module_default2.expand,
            onClick: () => {
              big ? comeBack() : goBig();
            },
            children: big ? "Close (Esc)" : "Fullscreen"
          }, undefined, false, undefined, this),
          /* @__PURE__ */ jsxDEV2(SealedHtmlPreview, {
            html: html2,
            title: "The page the agent wrote",
            fill: true
          }, undefined, false, undefined, this)
        ]
      }, undefined, true, undefined, this) : /* @__PURE__ */ jsxDEV2("p", {
        className: styles_module_default2.quiet,
        children: problem ?? "A drawing saved as a piece reopens from the Library after a reload. One written " + "straight into a reply is kept for this session only, so open it again from the " + "reply it came from."
      }, undefined, false, undefined, this)
    ]
  }, undefined, true, undefined, this);
}
var app = {
  manifest: {
    ...
    catalogOnly: true,
    agentSurface: {
      describe: "HTML View draws a page as a full tab. Write it in an ```html block - the PERSON opens it, " + "no tool does. Sealed and offline: all CSS works, images only as data: URIs. No " + "JavaScript, no iframe/form/input/button, no http(s) image, font or fetch. Static " + "wireframes and mockups only.",
      actions: [
        {
          id: "css",
          label: "What renders",
          describe: "Every CSS feature: grid, flexbox, custom properties, gradients, transforms, " + "animations, media and container queries. Inline <style> and style attributes. " + "Tables, semantic layout, inline SVG, unicode."
        },
        {
          id: "blocked",
          label: "What is dropped, silently",
          describe: "<script> and every event attribute - no JavaScript runs. iframe, object, embed, form, " + "input, button, textarea, select, link, meta, base are stripped. Reaching for one " + "leaves a page missing that part."
        },
        {
          id: "offline",
          label: "The frame is offline",
          describe: "No http(s) request of any kind resolves: a remote image is a blank box and a webfont " + "falls back to a system font. Images must be data: URIs. Assume no network and no " + "fonts beyond the system stack."
        },
        {
          id: "interactive",
          label: "When asked for interactive",
          describe: "Say plainly that this surface cannot run scripts and offer the static version - " + "states drawn side by side, or a flow shown as steps. Do not ship a page whose " + "behaviour will silently not happen."
        }
      ]
    }
  },
...
var html_view_default = app;
export {
  html_view_default as default,
  HtmlView
};
