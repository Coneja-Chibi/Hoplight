...
| BentoCard | src/ui/components/bento-card/index.tsx | ({ title, icon, aff, filled, off, offMode = "dim", missing, onMove, scale = 1, onScale, children }: BentoCardProps) | One card of the editor bento. Folds from its chevron; lens states per vs-editor-2. Each card can | .card .off .head .mark .title .aff .dot .full ... |
