...
/** RoleCall's own sauce. Most of RC is canonical (Vaude was seeded from it); these are the
 * native-only fields. Paths into original.rolecall.raw. Verified from RC source (serialize-v2.ts,
 * tracker-presets.ts). Approved wireframe: design/vs-native-rolecall.html. */
