/**
 * InjectionCard (P4 v2) - "where your persona appears" as a BENTO tile (the character-editor
 * kinship ruling): stops via injectionsForProfile (the position-picker law), a foreign
 * already-set stop dashed amber and kept, depth where the stop takes one, role for ST's
 * in-chat, RC's wrapper text.
 */
...
export function InjectionCard({ body, onBody, stops, labels, showWrapper }: InjectionCardProps): JSX.Element {
  ...
  return (
    <BentoCard title="Prompt Injection" filled>
